...
이 문서는 XMLoom repository의 개발/Agent 중심 개요다. 서비스 사용자를 위한 첫 문서는 repo root의 [README](../../README.md)다.
...
- [Docs Hub](../README.md): Codex, Claude, 사람 개발자가 함께 보는 문서 시작점
- [Product PRD](../product/prd.md): 제품 요구사항, MVP 범위, acceptance criteria
- [Product Overview](../product/overview.md): 제품 목표와 규칙 기반 변환 요약
- [XML Conversion Spec](../specs/xml-conversion.md): XML 변환 입력/출력, tag fallback, escaping 규칙
- [Screen Spec](../specs/screen.md): mobile/tablet/desktop 화면 기준, spacing, 상태별 UI
- [Engineering](../development/engineering.md): 코드 관리, 커밋 규칙, 검증 명령어, 구현 원칙
- [Agent Guide](./guide.md): Agent가 다시 들어왔을 때 읽을 순서와 작업 방식
- [Agent Skills](./skills.md): 선택적 local skill과 shadcn/ui 사용 절차
- [PRD Changelog](../changelog/prd.md), [Spec Changelog](../changelog/specs.md): PRD와 스펙 변경 내역
- [Roadmap](../planning/roadmap.md): v0 문서화부터 v3 AI 보조 변환까지의 단계
