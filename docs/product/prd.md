...
문서 버전: `PRD-2026-05-03-001`  
상태: Draft  
마지막 갱신일: 2026-05-03

## Summary

XMLoom은 사용자가 자연어로 대충 작성한 여러 텍스트 입력을 예측 가능한 XML 문서로 변환하는 웹서비스다. 초기 제품은 규칙 기반 변환 도구이며, OpenAI API나 LLM 호출은 MVP 범위에 포함하지 않는다.
...
- copy success/failure 상태를 명확히 표시한다.
